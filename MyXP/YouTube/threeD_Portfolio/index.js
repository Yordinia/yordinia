...
console.log(scene)
// camera
const camera = new THREE.ProspectiveCamera( 75, 360)
/*

aspect ratio window.innerWidth / window.innerHeight, 0.1 , 1000 last two are view frustrum, how far we can see )
